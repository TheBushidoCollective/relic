...
/**
 * Register both frame adapters with the central anchoring registry.
 * Safe to call multiple times; idempotency prevents duplicate registration.
 */
export function registerFrameAdapters(): void {
